...
export default function NouveauLivrePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/livre`, {
        method: 'POST',
  ...
  return (
    <div>
      <h2 className="font-semibold text-xl text-slate-900 mb-6">Ajouter un livre</h2>
